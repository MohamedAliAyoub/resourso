                ...
                <div class="container">
                    <div class="row">
                        <!-- <div class="col-md-4">
                            <div class="col_content_icons box_3_icon">
                                ...
                                <div class="content_img_related">
                                    <img src="{{asset('vendors/images/related/8.png')}}" class="m_b_123" >
                                    <img src="{{asset('vendors/images/related/9.png')}}" class="m_b_123" >
                                </div>
                                <p class="title_hader"> مكتبة الملك فهد الوطنية  </p>
                                                        <span class="words d-none-">  خدمة إرشادية للوصول لمواقع المدارس التابعة لإدارة التعليم بمحافظةالمخواة  </span>

                                <button class="btn btn-info btn-block btn-lg">
                                   
                                    <a href="https://kfnl.gov.sa/Ar/Pages/default.aspx">
                        ...
                        <!-- <div class="col-md-4">
                            <div class="col_content_icons box_3_icon">
                                <div class="content_img_related">
                                    <img src="{{asset('vendors/images/related/10.png')}}" class="m_b_123" >
                                </div>                        <p class="title_hader"> المكتبه الرقميه السعوديه   </p>
                                                        <span class="words d-none-">  خدمة إرشادية للوصول لمواقع المدارس التابعة لإدارة التعليم بمحافظةالمخواة  </span>
                        ...
                        @foreach($libraries as $education)
                            <div class="col-md-4">
                                <div class="col_content_icons box_3_icon">
                                    <div class="content_img_related">
