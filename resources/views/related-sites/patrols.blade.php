...
<div class="container">
    ...
    <h1 class="ribbon-title--a">   المدرسة اإلفتراضية  مواقع ذات صله    </h1>
            ...
            <div class="row">
                ...
                <!-- <div class="col-md-4">
                    <div class="col_content_icons box_3_icon">
                        ...
                        <p class="title_hader">   منصة مدرستي  </p>
                        <span class="words d-none-">  خدمة إرشادية للوصول لمواقع المدارس التابعة لإدارة التعليم بمحافظةالمخواة  </span>
                        <button class="btn btn-info btn-block btn-lg"> <a href="https://edu.moe.gov.sa/Mokhwah/Pages/default.aspx">
                ...
                <!-- <div class="col-md-4">
                    <div class="col_content_icons box_3_icon">
                        <div class="content_img_related">
                            <img src="{{asset('vendors/images/related/5.png')}}"  >
                        </div>
                        <p class="title_hader"> عين بوابه التعليم الوطنيه </p>
                        <span class="words d-none-">  خدمة إرشادية للوصول لمواقع المدارس التابعة لإدارة التعليم بمحافظةالمخواة  </span>
                        <button class="btn btn-info btn-block btn-lg"> <a href="https://ien.edu.sa/Home/Dashbord">
                               اذهب الى الموقع الان
                                <i class="fas fa-location-arrow icon_go_btn"></i>
                            </a> </button>
                    </div>
                </div> -->
                @foreach($virtualSchool as $education)
                    <div class="col-md-4">
                        <div class="col_content_icons box_3_icon">
                            <div class="content_img_related">
