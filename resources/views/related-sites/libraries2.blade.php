                ...
                <div class="container">
                    <div class="row">
                        <!-- <div class="col-md-4">
                            <div class="col_content_icons box_3_icon">
                                ...
                                <div class="content_img_related">
                                    <img src="{{asset('vendors/images/related/12.png')}}"  >
                                </div>
                                <p class="title_hader"> معهد اإلدارة العامة </p>
                                                        <span class="words d-none-">  خدمة إرشادية للوصول لمواقع المدارس التابعة لإدارة التعليم بمحافظةالمخواة  </span>

                                <button class="btn btn-info btn-block btn-lg">

                                    <a href="https://ncepd.moe.gov.sa/ar/Pages/default.aspx">
                        ...
                        <!-- <div class="col-md-4">
                            <div class="col_content_icons box_3_icon">
                                <div class="content_img_related">
                                    <img src="{{asset('vendors/images/related/13.png')}}"   >
                                </div>                        <p class="title_hader">  المركز الوطنى للتطوير المهنى التعليمي  </p>
                                                        <span class="words d-none-">  خدمة إرشادية للوصول لمواقع المدارس التابعة لإدارة التعليم بمحافظةالمخواة  </span>
                        ...
                        @foreach($libraries2 as $education)
                            <div class="col-md-4">
                                <div class="col_content_icons box_3_icon">
                                    <div class="content_img_related">
